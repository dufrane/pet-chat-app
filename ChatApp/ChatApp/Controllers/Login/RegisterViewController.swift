...
class RegisterViewController: UIViewController {
    ...
    private let registerButton: UIButton = {
        ...
        button.backgroundColor = #colorLiteral(red: 0, green: 0.6196910143, blue: 0.2123850584, alpha: 1)
...
//                                                            action: #selector(didTapRegister))
    ...
    private func alertUserLoginError() {
        let alert = UIAlertController(title: "Ah no", message: "Please enter all information to create a new account.", preferredStyle: .alert)
